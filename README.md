Name: Wireless Haxxoring
Description: 
It's 1997 and your friend's neighbor is an electrical engineer working with the
...
To Distribute:
Just give out the dist/encrypted_packets.txt file
